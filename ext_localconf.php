...
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['cfc_league']['search_Competition_getTableMapping_hook'][] = System25\T3sports\DfbSync\Hook\Search::class.'->getTableMappingCompetition';
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['cfc_league']['search_Competition_getJoins_hook'][] = System25\T3sports\DfbSync\Hook\Search::class.'->getJoinsCompetition';
